...
> **📝 Release Changes:** See the [Changelog](CHANGELOG.md) for public API additions, fixes, and release notes.
...
Public release changes are documented in [CHANGELOG.md](CHANGELOG.md).
