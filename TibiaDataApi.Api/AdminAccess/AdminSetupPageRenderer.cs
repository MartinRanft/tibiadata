...
{
    internal static class AdminSetupPageRenderer
    {
        public static string Render(string returnUrl, string antiforgeryToken, string? errorMessage = null)
        {
            ...
            return $$"""
                     ...
                     <head>
                         ...
                         <title>{{AdminAccessDefaults.AdminUiTitle}} Setup</title>
                         <style>
                             :root {
                                 color-scheme: light;
                                 --bg: #f3efe5;
                     ...
                     <body>
                         <main class="panel">
                             <h1>Admin Setup</h1>
                             <p>Create the first admin password. The password is stored securely as a hash in the database.</p>
                             {{errorHtml}}
                             ...
                             <p class="hint">After setup you will be redirected to {{encodedReturnUrl}}.</p>
                         </main>
                     </body>
                     </html>
                     """;
