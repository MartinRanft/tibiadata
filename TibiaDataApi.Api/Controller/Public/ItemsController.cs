...
namespace TibiaDataApi.Controller.Public
{
    ...
    public sealed class ItemsController(IItemsDataBaseService itemsDataBaseService) : PublicApiControllerBase
    {
        ...
        [EndpointDescription("Retrieves a paged list of items.")]
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            PagedResponse<ItemListItemResponse> items = await itemsDataBaseService.GetItemsAsync(page, pageSize, cancellationToken);
            return Ok(items);
        }
