...
namespace TibiaDataApi.Services.Assets
{
        ...
        ILogger<CreatureImageSyncService> logger) : ICreatureImageSyncService
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            Asset? primaryAsset = await db.CreatureAssets
                                          .Where(entry => entry.CreatureId == creatureId &&
            ...
            bool hasPrimaryAsset = primaryAsset is not null;
            bool isPrimaryAssetMissingMd5 = hasPrimaryAsset &&
                                            string.IsNullOrWhiteSpace(primaryAsset!.ContentMd5);
            ...
            bool shouldQueue = forceSync || !hasPrimaryAsset || isPrimaryAssetMissingMd5 || existingEntry is null ||
