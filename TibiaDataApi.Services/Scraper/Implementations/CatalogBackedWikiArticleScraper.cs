...
namespace TibiaDataApi.Services.Scraper.Implementations
{
        ...
        ILogger logger) : WikiScraperBase(tibiaWikiHttpService, logger)
    {
        ...
        {
            Dictionary<string, string> values = ParseInfoboxValues(rawWikiText);
        ...
        private static string? ExtractAdditionalAttributes(string rawWikiText, WikiContentType contentType)
        {
            ...
            Dictionary<string, string> infoboxValues = ParseInfoboxValues(rawWikiText);
            ...
            HashSet<string> lowerLevelStructuralKeys = new(StringComparer.OrdinalIgnoreCase)
            {
                "areaname",
                "lvlknights",
                "lvlpaladins",
            ...
            if(!lowerLevelData.Keys.Any(lowerLevelStructuralKeys.Contains))
            {
                return null;
            }
        ...
        private static Dictionary<string, string> ParseInfoboxValues(string rawWikiText)
        {
