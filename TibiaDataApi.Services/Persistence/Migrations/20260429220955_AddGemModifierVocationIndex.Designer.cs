...
namespace TibiaDataApi.Services.Persistence.Migrations
{
    ...
    [Migration("20260429220955_AddGemModifierVocationIndex")]
    partial class AddGemModifierVocationIndex
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.Gem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("GemFamily")
                        .HasColumnType("int");

                    b.Property<int>("GemSize")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("VocationRestriction")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VocationRestriction");

                    b.HasIndex("GemFamily", "GemSize");

                    b.ToTable("gems", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.GemModifier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasTradeoff")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsComboMod")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.HasIndex("ModifierType", "Category");

                    b.HasIndex("ModifierType", "VariantKey")
                        .IsUnique();

                    b.HasIndex("Name", "ModifierType", "VocationRestriction");

                    b.ToTable("gem_modifiers", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.GemModifierGrade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("GemModifierId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("GemModifierId", "Grade")
                        .IsUnique();

                    b.ToTable("gem_modifier_grades", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("IsGenericAcrossVocations")
                        .HasColumnType("tinyint(1)");
                    ...
                    b.Property<string>("MainSourceTitle")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("MainSourceUrl")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)");
                    ...
                    b.HasIndex("Vocation", "IsActive");

                    b.HasIndex("Vocation", "Slug")
                        .IsUnique();

                    b.HasIndex("Vocation", "Type");

                    b.ToTable("wheel_perks", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerkOccurrence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<byte?>("Domain")
                    ...
                    b.Property<short>("OccurrenceIndex")
                        .HasColumnType("smallint");

                    b.Property<short?>("RequiredPoints")
                        .HasColumnType("smallint");

                    b.Property<int>("WheelPerkId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("WheelPerkId", "Domain");

                    b.HasIndex("WheelPerkId", "OccurrenceIndex")
                        .IsUnique();

                    b.ToTable("wheel_perk_occurrences", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerkStage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("EffectDetailsJson")
                        .HasColumnType("json");
                    ...
                    b.HasIndex("WheelPerkId", "SortOrder");

                    b.HasIndex("WheelPerkId", "Stage")
                        .IsUnique();

                    b.ToTable("wheel_perk_stages", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelRevelationSlot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("WheelPerkOccurrenceId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("WheelPerkId");

                    b.HasIndex("WheelPerkOccurrenceId");

                    b.HasIndex("Vocation", "SlotKey")
                        .IsUnique();

                    b.ToTable("wheel_revelation_slots", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("ConvictionWheelPerkId")
                        .HasColumnType("int");

                    b.Property<int?>("ConvictionWheelPerkOccurrenceId")
                        .HasColumnType("int");

                    b.Property<int>("Quarter")
                        .HasColumnType("int");

                    b.Property<byte>("RadiusIndex")
                        .HasColumnType("tinyint unsigned");
                    ...
                    b.Property<short>("SectionPoints")
                        .HasColumnType("smallint");
                    ...
                    b.HasIndex("ConvictionWheelPerkId");

                    b.HasIndex("ConvictionWheelPerkOccurrenceId");

                    b.HasIndex("Vocation", "SectionKey")
                        .IsUnique();

                    b.HasIndex("Vocation", "Quarter", "SortOrder")
                        .IsUnique();

                    b.ToTable("wheel_sections", (string)null);
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelSectionDedicationPerk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("WheelSectionId", "SortOrder")
                        .IsUnique();

                    b.HasIndex("WheelSectionId", "WheelPerkId")
                        .IsUnique();

                    b.ToTable("wheel_section_dedication_perks", (string)null);
                });
            ...
            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.GemModifierGrade", b =>
                {
                    b.HasOne("TibiaDataApi.Services.Entities.WheelOfDestiny.GemModifier", "GemModifier")
                        .WithMany("Grades")
                        .HasForeignKey("GemModifierId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GemModifier");
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerkOccurrence", b =>
                {
                    b.HasOne("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerk", "WheelPerk")
                        .WithMany("Occurrences")
                        .HasForeignKey("WheelPerkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WheelPerk");
                });
            ...
            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelRevelationSlot", b =>
                {
                    ...
                    b.HasOne("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerkOccurrence", "WheelPerkOccurrence")
                        .WithMany()
                        .HasForeignKey("WheelPerkOccurrenceId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("WheelPerk");

                    b.Navigation("WheelPerkOccurrence");
                });

            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelSection", b =>
                {
                    b.HasOne("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerk", "ConvictionWheelPerk")
                        .WithMany()
                        .HasForeignKey("ConvictionWheelPerkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelPerkOccurrence", "ConvictionWheelPerkOccurrence")
                        .WithMany()
                        .HasForeignKey("ConvictionWheelPerkOccurrenceId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ConvictionWheelPerk");

                    b.Navigation("ConvictionWheelPerkOccurrence");
                });
            ...
            modelBuilder.Entity("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelSectionDedicationPerk", b =>
                {
                    ...
                    b.HasOne("TibiaDataApi.Services.Entities.WheelOfDestiny.WheelSection", "WheelSection")
                        .WithMany("DedicationPerks")
                        .HasForeignKey("WheelSectionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WheelPerk");

                    b.Navigation("WheelSection");
                });
