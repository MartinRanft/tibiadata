    ...
    public sealed class ItemImageSyncServiceTests
    {
        ...
        public async Task QueuePrimaryImageSyncAsync_AddsPendingQueueEntry_WhenPrimaryAssetIsMissingMd5()
        {
            ...
            Item item = new()
            {
                ...
                NormalizedName = "dragon scale mail"
            };

            Asset asset = new()
            {
                StorageKey = "items/1/primary.gif",
            ...
            dbContext.ItemAssets.Add(new ItemAsset
            {
                ItemId = item.Id,
                Item = item,
                AssetId = asset.Id,
            ...
            await service.QueuePrimaryImageSyncAsync(item.Id, "Dragon Scale Mail", false);
